...
--------------------------`;
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const response = await fetch('https://d2c06jif1gr2lf.cloudfront.net/api/search/search', {
        method: 'POST',
        headers: {
      ...
      try {
        ...
        const logResponse = await fetch('https://d2c06jif1gr2lf.cloudfront.net/api/search/search', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
  ...
  const fetchDatabaseStatus = async () => {
    try {
      ...
      let response = await fetch('https://d2c06jif1gr2lf.cloudfront.net/api/search/status');
      
      // If that fails, try the alternative endpoint
      if (!response.ok) {
        response = await fetch('https://d2c06jif1gr2lf.cloudfront.net/api/audit-logs');
      }
  ...
  const fetchImportStats = async () => {
    try {
      ...
      const response = await fetch('https://d2c06jif1gr2lf.cloudfront.net/api/imports/recent');
      if (!response.ok) {
